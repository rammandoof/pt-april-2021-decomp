...
function pepperman_decide_attack_phase5()
{
    ...
    else
    {
        ...
        groundpound_fakeout = 1;
        readjusting = 0;
        state = (irandom(100) > 50) ? choose(states.enemy_charge, states.enemy_charge, states.shoulder) : states.jump;
...
function pepperman_decide_attack_phase1()
{
    ...
    else
    {
        ...
        shoulderpound_fakeout = (phase == 4) ? 1 : 0;
        superjumping_pepper = (phase == 4) ? 1 : 0;
        
        if (phase == 6)
        {
            shoulderpound_fakeout = (irandom(100) > 60) ? 1 : 0;
            superjumping_pepper = (irandom(100) > 50) ? 1 : 0;
        }
        ...
        if (phase > 1)
        {
            ...
            jumping_pepper = (irandom(100) > chance_jumping) ? 1 : 0;
            shoulderbash_fakeout = (irandom(100) > chance_fakeout) ? 1 : 0;

...
function vigilante_decide_attack_phase4()
{
    ...
    else
    {
        ...
        state = choose(states.boss_groundpunchstart, states.enemy_charge, states.boss_millionpunch);
...
function vigilante_decide_attack_phase3()
{
    ...
    else
    {
        ...
        else if (state == states.mach1)
        {
            ...
            superkickattack_jump = (irandom(100) > 30) ? 1 : 0;
            movespeed = 0;
...
function boss_vigilante_revolver()
{
    ...
    if (phase > 4)
        vigilante_cancel_attack(states.dynamite, states.enemy_charge);
}
...
function boss_vigilante_mach1()
{
    ...
    if (phase > 4)
        vigilante_cancel_attack(!honor ? states.revolver : states.handstandjump, states.enemy_charge);
}
...
function boss_vigilante_crouchslide()
{
    ...
    if (phase > 4)
        vigilante_cancel_attack(states.boss_groundpunchstart, states.enemy_charge, states.uppunch);
}

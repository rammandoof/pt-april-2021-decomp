...
ds_map_set(boss_hurtstates, states.shoulderbash, 30);
ds_map_set(boss_hurtstates, states.shoulder, 30);
ds_map_set(boss_hurtstates, states.boss_supershoulderbash, 60);
ds_map_set(boss_hurtstates, states.superslam, 200);
ds_map_set(boss_hurtstates, states.freefall, 30);
